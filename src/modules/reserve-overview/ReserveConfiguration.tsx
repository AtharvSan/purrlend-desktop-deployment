      ...
      >
        {reserve.isFrozen ? (
          <Warning severity="error">
            <Trans>
              This asset is frozen. You can still repay and withdraw, but you cannot supply or
              borrow.
            </Trans>
          </Warning>
        ) : (
        ...
        <>
          ...
          <PanelRow>
            ...
            <Box sx={{ flexGrow: 1, minWidth: 0, maxWidth: '100%', width: '100%' }}>
              ...
              >
                E-Mode boosts your LTV for assets within the same category, giving you higher
                borrowing power. Categories are set by governance. You can enable E-Mode in your{' '}
                <Link
